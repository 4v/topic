...
body {
	...
	background-image: url(<%=basePath%>resources/core/images/light.png);
...
<body>
			...
			<div class="loginbox loginbox2">
				<ul>
					...
					<li class="yzm"><span><input name="verifyCode"
							type="text" value="验证码" onclick="JavaScript:this.value=''" /></span> <cite><img
	...
	<div class="loginbm">Copyright © 2015 www.4Tiro.com belongs to
		DyEnigma. All Rights Reserved.</div>
</body>
</html>
